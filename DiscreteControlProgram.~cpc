<CalcPaths_Export_File>
	<Simulator after_time="1000" max_steps="0" sample_time="0.01" simulation_rate="0" simulation_ratio="1e-11" start_time="1984-01-01T00:00:00.000" stop_condition="2" stop_time="1984-01-01T00:00:00.000"/>
	<Paths>
		<PATH ID="1" block_id="-1" index="-1" name="Path 1">
			<Paths>
						...
						<Object ID="9" flip="false" index="5" name="Display 1" type="display">
							...
							<Display>
								<Properties>
									...
									<Property name="Height" type="int" value="45"/>
									<Property name="Chart min" type="real" value="-0.56998602971572"/>
									<Property name="Chart max" type="real" value="1.10738493557098"/>
				...
				<PATH ID="3" block_id="4" index="-1" name="Element wykonawczy">
					...
					<Objects>
						<Object ID="0" flip="false" index="0" name="CV" type="subpath_input">
							...
							<Display>
								<Properties>
									<Property name="Color" type="color" value="15780518"/>
									<Property name="Left" type="int" value="208"/>
						...
						<Object ID="1" flip="false" index="1" name="Wyjście" type="subpath_output">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
									<Property name="Index" type="int" value="1"/>
							...
							<Display>
								<Properties>
									<Property name="Color" type="color" value="12639424"/>
									<Property name="Left" type="int" value="1333"/>
						...
						<Object ID="4" flip="false" index="2" name="Signum" type="signum">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
								</Properties>
						...
						<Object ID="5" flip="false" index="3" name="Wzmocnienie" type="gain">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
									<Property name="Gain" type="real" value="2.2"/>
									<Property name="Clear sig. status" type="bool" value="false"/>
								</Properties>
							</Transform>
							<Display>
								<Properties>
									<Property name="Color" type="color" value="12632256"/>
									<Property name="Left" type="int" value="1183"/>
						...
						<Object ID="6" flip="false" index="4" name="Periodical signal 1" type="src_periodic">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
							...
							<Display>
								<Properties>
									<Property name="Color" type="color" value="15780518"/>
									<Property name="Left" type="int" value="193"/>
						...
						<Object ID="7" flip="false" index="5" name="Absolute 1" type="math_absolute">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
								</Properties>
						...
						<Object ID="8" flip="false" index="6" name="Relational operator 1" type="relational">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
						...
						<Object ID="9" flip="false" index="7" name="Product 1" type="product">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
							...
							<Display>
								<Properties>
									<Property name="Color" type="color" value="12632256"/>
									<Property name="Left" type="int" value="934"/>
						...
						<Object ID="10" flip="false" index="8" name="Constant 1" type="constant">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
									<Property name="Value" type="real" value="0.001"/>
							...
							<Display>
								<Properties>
									<Property name="Color" type="color" value="15780518"/>
									<Property name="Left" type="int" value="343"/>
									<Property name="Top" type="int" value="461"/>
									<Property name="Width" type="int" value="100"/>
									<Property name="Height" type="int" value="30"/>
								</Properties>
							</Display>
						</Object>
						<Object ID="11" flip="false" index="9" name="Relational operator 2" type="relational">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
									<Property name="Type" type="enum" value="1">
							...
							<Display>
								<Properties>
									<Property name="Color" type="color" value="12632256"/>
									<Property name="Left" type="int" value="572"/>
									<Property name="Top" type="int" value="446"/>
									<Property name="Width" type="int" value="60"/>
									<Property name="Height" type="int" value="45"/>
								</Properties>
							</Display>
						</Object>
						<Object ID="12" flip="false" index="10" name="Product 2" type="product">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
									<Property name="Actions string" type="string" value="**"/>
							...
							<Display>
								<Properties>
									<Property name="Color" type="color" value="12632256"/>
									<Property name="Left" type="int" value="1065"/>
					...
					<Connections>
						...
						<Connection begin_id="6" begin_idx="0" end_id="8" end_idx="1" type="1">
							<Display type="1">
								<Segments size="3">
									<Segment index="0" value="280"/>
						...
						<Connection begin_id="0" begin_idx="0" end_id="4" end_idx="0" type="1">
							<Display type="1">
								<Segments size="3">
									...
									<Segment index="2" value="334"/>
								</Segments>
							</Display>
							<Properties/>
						</Connection>
						<Connection begin_id="8" begin_idx="0" end_id="9" end_idx="1" type="1">
							<Display type="1">
								<Segments size="3">
						...
						<Connection begin_id="12" begin_idx="0" end_id="5" end_idx="0" type="1">
							<Display type="1">
								<Segments size="3">
						...
						<Connection begin_id="11" begin_idx="0" end_id="12" end_idx="1" type="1">
							<Display type="1">
								<Segments size="3">
									<Segment index="0" value="399"/>
									<Segment index="1" value="-150"/>
									<Segment index="2" value="39"/>
								</Segments>
							</Display>
							<Properties/>
			...
			<Objects>
				...
				<Object ID="2" flip="false" index="2" name="PID 1" type="pid_controller">
					<Transform>
						<Properties>
							<Property name="Processing rate" type="int" value="1"/>
							<Property name="k" type="real" value="0.05"/>
							<Property name="Ti" type="real" value="230"/>
							<Property name="Td" type="real" value="60"/>
					...
					<Display>
						<Properties>
							<Property name="Color" type="color" value="12632256"/>
							<Property name="Left" type="int" value="535"/>
				...
				<Object ID="3" flip="true" index="3" name="Display 1" type="display">
					...
					<Display>
						<Properties>
							...
							<Property name="Width" type="int" value="170"/>
							<Property name="Height" type="int" value="60"/>
							<Property name="Chart min" type="real" value="-0.485152289930816"/>
							<Property name="Chart max" type="real" value="10.8226660438767"/>
							<Property name="Autoscale" type="bool" value="false"/>
							<Property name="Scale each sep." type="bool" value="false"/>
							<Property name="Precision" type="int" value="3"/>
							<Property name="Digits" type="int" value="3"/>
				...
				<Object ID="6" flip="false" index="6" name="Disp wskaz jakosci" type="display">
					<Transform>
						<Properties>
							<Property name="Processing rate" type="int" value="1"/>
							<Property name="Buffer length" type="uint" value="200000"/>
							<Property name="Inputs count" type="uint" value="1"/>
						</Properties>
					</Transform>
					<Display>
						<Properties>
							...
							<Property name="Chart max" type="real" value="1098.49376295267"/>
							<Property name="Autoscale" type="bool" value="false"/>
							<Property name="Scale each sep." type="bool" value="false"/>
							<Property name="Precision" type="int" value="3"/>
							<Property name="Digits" type="int" value="3"/>
				...
				<Object ID="7" flip="false" index="7" name="Display 2" type="display">
					<Transform>
						<Properties>
							<Property name="Processing rate" type="int" value="1"/>
							<Property name="Buffer length" type="uint" value="100000"/>
					...
					<Display>
						<Properties>
							<Property name="Color" type="color" value="12639424"/>
							<Property name="Left" type="int" value="1250"/>
							<Property name="Top" type="int" value="251"/>
							<Property name="Width" type="int" value="170"/>
							<Property name="Height" type="int" value="45"/>
			...
			<Connections>
				...
				<Connection begin_id="1" begin_idx="0" end_id="3" end_idx="0" type="1">
					<Display type="1">
						<Segments size="3">
							<Segment index="0" value="155"/>
							<Segment index="1" value="319"/>
				...
				<Connection begin_id="4" begin_idx="0" end_id="7" end_idx="0" type="1">
					<Display type="1">
						<Segments size="3">
