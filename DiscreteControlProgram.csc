<CalcPaths_Export_File>
	<Simulator after_time="1000" max_steps="0" sample_time="0.1" simulation_rate="0" simulation_ratio="1e-11" start_time="1984-01-01T00:00:00.000" stop_condition="2" stop_time="1984-01-01T00:00:00.000"/>
	<Paths>
			...
			<Paths>
				...
				<PATH ID="3" block_id="4" index="-1" name="Element wykonawczy">
					...
					<Objects>
						...
						<Object ID="2" flip="false" index="2" name="Suma" type="sum">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
						...
						<Object ID="3" flip="false" index="3" name="Limiter sygnalu" type="signal_limiter">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
									<Property name="Low limit" type="real" value="-0.005"/>
									<Property name="High limit" type="real" value="0.005"/>
						...
						<Object ID="4" flip="false" index="4" name="Signum" type="signum">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
								</Properties>
						...
						<Object ID="5" flip="false" index="5" name="Wzmocnienie" type="gain">
							<Transform>
								<Properties>
									<Property name="Processing rate" type="int" value="1"/>
									<Property name="Gain" type="real" value="3"/>
									<Property name="Clear sig. status" type="bool" value="false"/>
								</Properties>
							</Transform>
							<Display>
								<Properties>
									<Property name="Color" type="color" value="12632256"/>
									<Property name="Left" type="int" value="988"/>
									<Property name="Top" type="int" value="310"/>
									<Property name="Width" type="int" value="60"/>
									<Property name="Height" type="int" value="30"/>
								</Properties>
			...
			<Objects>
				...
				<Object ID="1" flip="false" index="1" name="Time event 1" type="src_time_event">
					<Transform>
						<Properties>
							...
							<Property name="Bias" type="real" value="40"/>
				...
				<Object ID="2" flip="false" index="2" name="PID 1" type="pid_controller">
					<Transform>
						<Properties>
							<Property name="Processing rate" type="int" value="1"/>
							<Property name="k" type="real" value="0.0005"/>
							<Property name="Ti" type="real" value="1400"/>
				...
				<Object ID="3" flip="true" index="3" name="Display 1" type="display">
					...
					<Display>
						<Properties>
							...
							<Property name="Width" type="int" value="170"/>
							<Property name="Height" type="int" value="60"/>
							<Property name="Chart min" type="real" value="-0.00774176081132839"/>
							<Property name="Chart max" type="real" value="58.8288388836488"/>
							<Property name="Autoscale" type="bool" value="false"/>
							<Property name="Scale each sep." type="bool" value="false"/>
							<Property name="Precision" type="int" value="3"/>
							<Property name="Digits" type="int" value="3"/>
				...
				<Object ID="6" flip="false" index="6" name="Disp wskaz jakosci" type="display">
					...
					<Display>
						<Properties>
							...
							<Property name="Chart max" type="real" value="3822.53224584964"/>
							<Property name="Autoscale" type="bool" value="false"/>
							<Property name="Scale each sep." type="bool" value="false"/>
							<Property name="Precision" type="int" value="3"/>
							<Property name="Digits" type="int" value="3"/>
				...
				<Object ID="7" flip="false" index="7" name="Display 2" type="display">
					...
					<Display>
						<Properties>
							<Property name="Color" type="color" value="12639424"/>
							<Property name="Left" type="int" value="1251"/>
							<Property name="Top" type="int" value="251"/>
							<Property name="Width" type="int" value="170"/>
							<Property name="Height" type="int" value="45"/>
